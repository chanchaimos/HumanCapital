            ...
            <div class="row">
                <div class="col-lg-auto col-12">
                    <div class="form-group ">
                        <a id="btnAdd" class="btn btn-success" href="admin_permission_edit.aspx" data-toggle="tooltip"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add</a>
                    </div>
                </div>
                ...
                <div id="divSearch" class="col">
                    <div class="form-row justify-content-end">
                        <div class="col-auto">
                            <div class="form-group">
                                <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Username / Name-Surname"></asp:TextBox>
                            </div>
                        </div>
                ...
                <table id="tbData" class="table table-bordered table-hover table-responsive-sm table-responsive-md">
                    <thead>
                        <tr class="valign-middle pad-primary">
                            ...
                            <th style="width: 15%" class="text-center" data-sort="sUserID">Username</th>
                            <th class="text-center" data-sort="sName">Name - Surname</th>
                            <th style="width: 15%" class="text-center" data-sort="sRole">User group</th>
                            <th style="width: 15%" class="text-center" data-sort="sActive">Status</th>
                            <th style="width: 15%" class="text-center" data-sort="sUpdateDate">Last Update</th>
