<%@ Page Title="" Language="C#" MasterPageFile="~/_MP_Front.master" AutoEventWireup="true" CodeFile="admin_company.aspx.cs" Inherits="admin_company" %>
            ...
            <div class="row">
                <div class="col-lg-auto col-12">
                    <div class="form-group ">
                        <a id="btnAdd" class="btn btn-success" href="admin_company_edit.aspx" data-toggle="tooltip"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add</a>
                        <button id="btnSync" class="btn btn-info"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp; Sync Company</button>
                    </div>
                </div>
                ...
                <div id="divSearch" class="col">
                    <div class="form-row justify-content-end">
                        <div class="col-auto">
                            <div class="form-group">
                                <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Company Name"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-auto">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlActive" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="0" Text="Non applicable"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                ...
                <table id="tbData" class="table table-bordered table-hover table-responsive-sm table-responsive-md">
                    <thead>
                        <tr class="valign-middle pad-primary">
                            ...
                            <th style="width: 20%" class="text-center" data-sort="sCompanyAbbr">Company Short Name</th>
                            <th style="width: 17%" class="text-center" data-sort="sCompanyType">Company Type</th>
                            <th style="width: 12%" class="text-center" data-sort="sActive">Status</th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphScript" runat="Server">
    <script type="text/javascript">
        var sPageEdit = "admin_company_edit.aspx";
        ...
        function SearchData(pageThis) {
            ...
            BlockUI();
            AjaxWebMethod('Search', { 'sName': GetValTextBox('txtName'), 'sCompanyType': GetValDropdown('ddlCompanyType'), 'sActive': GetValDropdown('ddlActive') }, function (data) {
                UnblockUI();
                if (data.d == SysProcess.SessionExpired) { PopupSessionTimeOut(); } else {
        ...
        function CreateDataRow(objData, nRowNo) {
            ...
            var isChecked = Enumerable.From(arrCheckBox).Where(function (w) { return w.nID == objData.nCompanyID }).ToArray().length > 0 ? "checked=''" : "";
            sHTML += '<td class="text-center">' +
        ($Permission == "A" && isCanDel ?
        ('<div class="checkbox"><input type="checkbox" name="cbRec_' + objData.nCompanyID + '" id="cbRec_' + objData.nCompanyID + '" value="' + objData.nCompanyID + '" ' + isChecked + '/>' +
        '<label for="cbRec_' + objData.nCompanyID + '">' + nRowNo + '.</label></div>') : nRowNo + '.') + '</td>';

            sHTML += "<td>" + objData.sCompanyName + "</td>";
            sHTML += "<td class='text-center'>" + objData.sCompanyAbbr + "</td>";
            sHTML += "<td class='text-center'>" + objData.sCompanyType + "</td>";
